...
- `packages/ai/src/cursor/store-migration.ts`: the legacy classification, mixed-store conflict filtering and unconditional identity coalescing loop, and the `entryToModel` compat spread.
